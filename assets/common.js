...
(function($){
	$.fn.navActiveChange = function(){
		...
		$('#sub a[href="'+url+'"]').addClass('active');

		//topicPathから globalNav active
		var txt = $('#topicPath').find('li').eq(1).text(),
				$img = $('#globalNav img[alt="'+txt+'"]');
		if($img.size()>0){
...
ga('create', 'UA-54292785-1', 'auto');
ga('send', 'pageview');

//form flow
$(".flowBar01 li:last-child").addClass("comp");